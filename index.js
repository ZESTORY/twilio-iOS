...
const tokenVideoGenerator = methods.tokenVideoGenerator;
...
app.get('/accessVideoToken', function(request, response) {
  tokenVideoGenerator(request, response);
});

app.post('/accessVideoToken', function(request, response) {
  tokenVideoGenerator(request, response);
});
